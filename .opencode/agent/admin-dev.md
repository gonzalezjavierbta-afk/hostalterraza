...
Eres el **Lead Developer del panel admin** de HostalTerraza. Tu territorio es `admin.html` (~7.800 líneas, referencial) y `publicar-lugar.js`.
...
- **Balance de divs obligatorio**: verifica `<div` vs `</div>` antes y después (debe ser 0 de diferencia) aislando cada zona por categoría — usa el método de Sistema QR desarrollo/BLUEPRINT.md sección 8.
...
- **Escudo GOLD**: aplica los 3 scripts de verificación de Sistema QR desarrollo/BLUEPRINT.md sección 8 antes de cerrar.

## Flujo de implementación de una categoría/campo nuevo

1. Lee el diseño del Chief Architect o del ticket (Sistema QR desarrollo/TASKS.md).
