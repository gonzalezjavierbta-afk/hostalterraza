...
-- Si tu tabla tiene otras columnas NOT NULL sin default, revísalas antes de
-- correr esto (Table Editor → organizaciones → columnas).
INSERT INTO organizaciones (nombre, slug, plan, activa, is_master_org, color_primario, nombre_app)
VALUES ('SaaS Master Admin', 'master-admin', 'enterprise', true, true, '#C8A96E', 'SaaS Master Admin')
